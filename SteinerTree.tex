...
\emph{Step 2.} We claim that $\H^1(D)=0$. 
Consider $\Sigma_u$ as a metric space with the geodesic distance. 
... Serve dire che $\Sigma_u$ è Ahlfors regolare.... 

It is easy to check that $A_u\subset \Sigma'$ hence
since $\Sigma'$ is connected, we have that $\Sigma'$ is in fact 
a competitor to the minimality of $\Sigma_u\in \M(A_u)$ hence $\H^1(\Sigma')\le \H^1(\Sigma_u)$.
But since 
\[
...
there exist $x\in X$ such that $A\defeq X\setminus\ENCLOSE{x}$ is totally disconnected hence
