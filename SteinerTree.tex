...
and $\H^1(S)<+\infty$. 
Consider $\Sigma_f' = (\Sigma_f\setminus S) \cup S'$.
We claim that $\Sigma_f'$ is pathwise connected. 
In fact given any two points $x,y\in \Sigma_f'$ since $\Sigma_f$ is connected 
and $\H^1(\Sigma_f)<+\infty$ there exists an injective curve $\gamma \subset \Sigma_f$ 
connecting $x$ and $y$. If $\gamma$ does not intersect $S$ then $\gamma\subset \Sigma_f'$.
...
in $\Sigma_f'$, proving the claim.
Since $\Sigma_f\in \M(A_f)$ we have $\H^1(\Sigma_f')\le \H^1(\Sigma_f)$
but since $\H^1(\Sigma_f') \le \H^1(\Sigma_f)-\H^1(S) + \H^1(S'\cup D)$ 
...
We map $v$ to the point $(0,0)\in \Sigma_f$. 
Then we consider the edges of $T$ meeting in $v$ and map them 
among the three segments of $\Sigma_f$ meeting in $(0,0)$. 
...
adjacent vertices of the tree in $\Sigma_f$.
...
Hence, by (ii), $A_0$ is homeomorphic to a subset of $\Sigma_f$.
\end{proof}
