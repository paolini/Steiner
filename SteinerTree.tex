...
\begin{proof}
  ...
  If $S_1$ contains no triple point then $\overline{S_1}=[H,Q]$ for some $Q$, 
  ...
  and if $T$ is any triple point of $S$ then $T\in \overline{B_r(P)}$ because 
  otherwise at least one of the three segments meeting in $T$ would have a direction 
  which is not going to meet the ball $\overline{B_\rho(P)}$ and is not going towards 
  ...
  We conclude that $S\setminus \overline{B_r(P)}$ does not contain triple points and 
